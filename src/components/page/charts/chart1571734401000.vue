<template>
    <div class="chart">
        <vue-draggable-resizable :x="43" :y="36" :w="345" :h="273" @dragging="(left, top) =>onDrag('chart1571734401000',left,top)" @resizing="(x, y, width, height) =>onResize('chart1571734401000',x, y, width, height)"  @activated="onActivated('chart1571734401000')">
            <div @click="deleteChart('chart1571734401000')" class="delete">删除</div>
            <div class="chart" ref="chart1571734401000" style="width: 345px;height:273px;"></div>
...
<script>
    ...
    export default {
        mounted() {
            let mconfig = {"chartId":"chart1571734401000","config":{"commonConfig":{"tooltip":{"trigger":"axis","axisPointer":{"type":"shadow","label":{"show":true}}},"title":{"text":"","textStyle":{"color":"#D6BC28","fontSize":14}},"textStyle":{"color":"#fff"}},"userConfig":{"x":"TJDATE","y":[{"id":"GWYPZZMJ","name":"国务院批准总面积"},{"id":"SZFPZZMJ","name":"省政府批准总面积"}],"yAxis":[{"type":"value","name":"面积","axisLabel":{"formatter":"{value} "}}]},"dataUrl":"http://localhost:8888/api/line/ydys/v1","width":345,"height":273,"dx":43,"dy":36},"chartType":1}
            ...
            getChartData(dataUrl).then((res)=>{
               ...
               echarts.registerTheme('chalk',jsonobj)
                this.$echarts = echarts.init(this.$refs.chart1571734401000, 'chalk', {
