<template>
    <div class="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1572250644000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1572250644000',x, y, width, height)"
                                 @activated="onActivated('chart1572250644000')">
            <div @click="deleteChart('chart1572250644000')" class="delete">删除</div>
            <div class="chart" ref="chart1572250644000"
                               style="width: 300px;height:300px;"
                               data-width="300" data-height="300" data-x="779" data-y="242"></div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.$echarts = echarts.init(this.$refs.chart1572250644000, 'chalk', {
