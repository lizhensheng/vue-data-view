<template>
    <div class="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1571920860000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1571920860000',x, y, width, height)"
                                 @activated="onActivated('chart1571920860000')">
            <div @click="deleteChart('chart1571920860000')" class="delete">删除</div>
            <div class="chart" ref="chart1571920860000"
                               style="width: 415px;height:262px;"
                               data-width="415" data-height="262" data-x="611" data-y="99"></div>
    ...
    export default {
        data(){
            return {
                ...
                width:10,
                height:10,
                chartId:'chart1571920860000'
            }
        },
        mounted() {
            let mconfig = {"chartId":"chart1571920860000","config":{"commonConfig":{"tooltip":{"trigger":"axis","axisPointer":{"type":"shadow","label":{"show":true}}},"title":{"text":"","textStyle":{"color":"#D6BC28","fontSize":14}},"textStyle":{"color":"#fff"}},"userConfig":{"x":"TJDATE","y":[{"id":"GWYPZZMJ","name":"国务院批准总面积"},{"id":"SZFPZZMJ","name":"省政府批准总面积"}],"yAxis":[{"type":"value","name":"面积","axisLabel":{"formatter":"{value} "}}]},"dataUrl":"http://localhost:8888/api/bar/ydys/v1","width":415,"height":262,"dx":611,"dy":99},"chartType":2}
            ...
            getChartData(dataUrl).then((res)=>{
               ...
               echarts.registerTheme('chalk',jsonobj)
                this.$echarts = echarts.init(this.$refs.chart1571920860000, 'chalk', {
                ...
                this.setPosition({id:'chart1571920860000',x:mconfig.config.dx,y:mconfig.config.dy,width:mconfig.config.width,height:mconfig.config.height})
            })
        },
        computed:{
             ...mapGetters(
