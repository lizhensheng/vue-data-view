<template>
    <div class="chart" ref="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1572315956000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1572315956000',x, y, width, height)"
                                 @activated="onActivated('chart1572315956000')">
            <div @click="deleteChart('chart1572315956000')" class="delete">删除</div>
            <div ref="chart1572315956000"
                               style="width: 300px;height:300px;"
                               data-width="300" data-height="300" data-x="295" data-y="117"></div>
...
<script>
    ...
    import {chartConfigClass} from 'common/js/chartconfig'
    ...
    export default {
        ...
        mounted() {
            ...
            this.$echarts = echarts.init(this.$refs.chart1572315956000, 'chalk', {
