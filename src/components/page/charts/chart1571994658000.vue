<template>
    <div class="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1571994658000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1571994658000',x, y, width, height)"
                                 @activated="onActivated('chart1571994658000')">
            <div @click="deleteChart('chart1571994658000')" class="delete">删除</div>
            <div class="chart" ref="chart1571994658000"
                               style="width: 300px;height:300px;"
                               data-width="300" data-height="300" data-x="577" data-y="165"></div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.$echarts = echarts.init(this.$refs.chart1571994658000, 'chalk', {
            ...
            getChartData(this.dataUrl).then((res)=>{
                ...
                this.setPosition({id:'chart1571994658000',x:mconfig.config.dx,y:mconfig.config.dy,width:mconfig.config.width,height:mconfig.config.height,xData:'',yData:[],yFields:[],dataId:''})
            })
        },
        computed:{
             ...mapGetters(
