<template>
    <div class="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1572250309000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1572250309000',x, y, width, height)"
                                 @activated="onActivated('chart1572250309000')">
            <div @click="deleteChart('chart1572250309000')" class="delete">删除</div>
            <div class="chart" ref="chart1572250309000"
                               style="width: 300px;height:300px;"
                               data-width="300" data-height="300" data-x="56" data-y="54"></div>
    ...
    export default {
        data(){
            return {
                ...
                width:10,
                height:10,
                chartId:'chart1572250309000'
            }
        },
        mounted() {
            let mconfig = {"chartId":"chart1572250309000","config":{"commonConfig":{"tooltip":{"trigger":"axis","axisPointer":{"type":"shadow","label":{"show":true}}},"title":{"text":"","textStyle":{"color":"#D6BC28","fontSize":14}},"textStyle":{"color":"#fff"}},"userConfig":{"x":"FDNAME","y":[{"id":"DEPTID","name":"DEPTID"}]},"dataUrl":"http://localhost:8888/api/getChartDataDynamic?id=5db3f7c87a12fb48206afe44","width":300,"height":300,"dx":56,"dy":54},"chartType":2}
            ...
            this.$echarts = echarts.init(this.$refs.chart1572250309000, 'chalk', {
