<template>
    <div class="chart" ref="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1572316912000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1572316912000',x, y, width, height)"
                                 @activated="onActivated('chart1572316912000')"  ref="draggable">
            <div @click="deleteChart('chart1572316912000')" class="delete">删除</div>
            <div ref="chart1572316912000"
                               style="width: 300px;height:300px;"
                               data-width="300" data-height="300" data-x="239" data-y="125"></div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.$echarts = echarts.init(this.$refs.chart1572316912000, 'chalk', {
        ...
        watch:{
            increaseId(){
                ...
                if(pos.backgroundColor){
                    console.log(this.$refs.draggable)
                    this.$refs.draggable.style.backgroundColor = pos.backgroundColor
                }
            },
            increaseIdForData(){
                this._refreshData()
