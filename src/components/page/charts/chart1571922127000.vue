<template>
    <div class="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1571922127000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1571922127000',x, y, width, height)"
                                 @activated="onActivated('chart1571922127000')">
            <div @click="deleteChart('chart1571922127000')" class="delete">删除</div>
            <div class="chart" ref="chart1571922127000"
                               style="width: 300px;height:300px;"
                               data-width="300" data-height="300" data-x="316" data-y="15"></div>
        ...
        mounted() {
            ...
            getChartData(dataUrl).then((res)=>{
               ...
               echarts.registerTheme('chalk',jsonobj)
                this.$echarts = echarts.init(this.$refs.chart1571922127000, 'chalk', {
                ...
                this.setPosition({id:'chart1571922127000',x:mconfig.config.dx,y:mconfig.config.dy,width:mconfig.config.width,height:mconfig.config.height})
            })
        },
        computed:{
             ...mapGetters(
