<template>
    <div class="chart" ref="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1572251920000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1572251920000',x, y, width, height)"
                                 @activated="onActivated('chart1572251920000')">
            <div @click="deleteChart('chart1572251920000')" class="delete">删除</div>
            <div class="chart" ref="chart1572251920000"
                               style="width: 300px;height:300px;"
                               data-width="300" data-height="300" data-x="206" data-y="262"></div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.$echarts = echarts.init(this.$refs.chart1572251920000, 'chalk', {
