<template>
    <div class="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1571921889000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1571921889000',x, y, width, height)"
                                 @activated="onActivated('chart1571921889000')">
            <div @click="deleteChart('chart1571921889000')" class="delete">删除</div>
            <div class="chart" ref="chart1571921889000"
                               style="width: 295px;height:220px;"
                               data-width="295" data-height="220" data-x="355" data-y="23"></div>
    ...
    export default {
        data(){
            return {
                ...
                width:10,
                height:10,
                chartId:'chart1571921889000'
            }
        },
        mounted() {
            let mconfig = {"chartId":"chart1571921889000","config":{"commonConfig":{"tooltip":{"trigger":"axis","axisPointer":{"type":"shadow","label":{"show":true}}},"title":{"text":"","textStyle":{"color":"#D6BC28","fontSize":14}},"textStyle":{"color":"#fff"}},"userConfig":{"x":"TJDATE","y":[{"id":"GWYPZZMJ","name":"国务院批准总面积"},{"id":"SZFPZZMJ","name":"省政府批准总面积"}],"yAxis":[{"type":"value","name":"面积","axisLabel":{"formatter":"{value} "}}]},"dataUrl":"http://localhost:8888/api/ring/ydys/v1","width":295,"height":220,"dx":355,"dy":23},"chartType":4}
            ...
            getChartData(dataUrl).then((res)=>{
               ...
               echarts.registerTheme('chalk',jsonobj)
                this.$echarts = echarts.init(this.$refs.chart1571921889000, 'chalk', {
                ...
                this.setPosition({id:'chart1571921889000',x:mconfig.config.dx,y:mconfig.config.dy,width:mconfig.config.width,height:mconfig.config.height})
            })
        },
        computed:{
             ...mapGetters(
