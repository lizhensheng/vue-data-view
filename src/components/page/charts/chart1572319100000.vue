<template>
    <div class="chart" ref="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1572319100000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1572319100000',x, y, width, height)"
                                 @activated="onActivated('chart1572319100000')"  ref="draggable">
            <div @click="deleteChart('chart1572319100000')" class="delete">删除</div>
            <div ref="chart1572319100000"
                               style="width: 300px;height:300px;"
                               data-width="300" data-height="300" data-x="491" data-y="179"></div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.$echarts = echarts.init(this.$refs.chart1572319100000, 'chalk', {
        ...
        watch:{
            increaseId(){
                ...
                if(pos.borderRadius){
                    this.$refs.draggable.$el.style.borderRadius = pos.borderRadius
                }
                if(pos.borderWidth){
                    this.$refs.draggable.$el.style.borderWidth = pos.borderWidth
                }
                if(pos.borderStyle){
