<template>
    <div class="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1572250708000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1572250708000',x, y, width, height)"
                                 @activated="onActivated('chart1572250708000')">
            <div @click="deleteChart('chart1572250708000')" class="delete">删除</div>
            <div class="chart" ref="chart1572250708000"
                               style="width: 300px;height:300px;"
                               data-width="300" data-height="300" data-x="472" data-y="388"></div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.$echarts = echarts.init(this.$refs.chart1572250708000, 'chalk', {
