<template>
    <div class="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1572066012000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1572066012000',x, y, width, height)"
                                 @activated="onActivated('chart1572066012000')">
            <div @click="deleteChart('chart1572066012000')" class="delete">删除</div>
            <div class="chart" ref="chart1572066012000"
                               style="width: 300px;height:300px;"
                               data-width="300" data-height="300" data-x="694" data-y="226"></div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.$echarts = echarts.init(this.$refs.chart1572066012000, 'chalk', {
            ...
            getChartData(this.dataUrl).then((res)=>{
                ...
                this.setPosition({id:'chart1572066012000',x:mconfig.config.dx,y:mconfig.config.dy,width:mconfig.config.width,height:mconfig.config.height,xData:'',yData:[],yFields:[],dataId:''})
            })
        },
        computed:{
             ...mapGetters(
