<template>
    <div class="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1571922770000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1571922770000',x, y, width, height)"
                                 @activated="onActivated('chart1571922770000')">
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.$echarts = echarts.init(this.$refs.chart1571922770000, 'chalk', {
            ...
            getChartData(dataUrl).then((res)=>{
                ...
                this.setPosition({id:'chart1571922770000',x:mconfig.config.dx,y:mconfig.config.dy,width:mconfig.config.width,height:mconfig.config.height})
            })
        },
        computed:{
             ...mapGetters(
