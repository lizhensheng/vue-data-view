<template>
    <div class="chart" ref="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1572324658000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1572324658000',x, y, width, height)"
                                 @activated="onActivated('chart1572324658000')"  ref="draggable">
            <div @click="deleteChart('chart1572324658000')" class="delete">删除</div>
            <div ref="chart1572324658000"
                               style="width: 300px;height:300px;"
                               data-width="300" data-height="300" data-x="231" data-y="158"></div>
    ...
    export default {
        data(){
            return {
                ...
                width:10,
                height:10,
                chartId:'chart1572324658000'
            }
        },
        mounted() {
            let mconfig = {"chartId":"chart1572324658000","config":{"commonConfig":{"tooltip":{"trigger":"axis","axisPointer":{"type":"shadow","label":{"show":true}}},"title":{"text":"","textStyle":{"color":"#D6BC28","fontSize":14}},"textStyle":{"color":"#fff"}},"userConfig":{"x":"TJDATE","y":[{"id":"GWYPZZMJ","name":"test1"},{"id":"SZFPZZMJ","name":"test2"}]},"dataUrl":"http://localhost:8888/api/bar/ydys/v1","width":300,"height":300,"dx":231,"dy":158,"backgroundColor":"rgba(136, 35, 35, 0.8)","borderRadius":5,"borderWidth":3,"borderStyle":"dotted","borderColor":"rgba(56, 29, 129, 1)"},"chartType":2}
            ...
            this.$echarts = echarts.init(this.$refs.chart1572324658000, 'chalk', {
