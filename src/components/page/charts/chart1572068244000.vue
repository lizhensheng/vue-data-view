<template>
    <div class="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1572068244000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1572068244000',x, y, width, height)"
                                 @activated="onActivated('chart1572068244000')">
            <div @click="deleteChart('chart1572068244000')" class="delete">删除</div>
            <div class="chart" ref="chart1572068244000"
                               style="width: 423px;height:378px;"
                               data-width="423" data-height="378" data-x="663" data-y="16"></div>
    ...
    export default {
        data(){
            return {
                ...
                width:10,
                height:10,
                chartId:'chart1572068244000'
            }
        },
        mounted() {
            let mconfig = {"chartId":"chart1572068244000","config":{"commonConfig":{"tooltip":{"trigger":"axis","axisPointer":{"type":"shadow","label":{"show":true}}},"title":{"text":"","textStyle":{"color":"#D6BC28","fontSize":14}},"textStyle":{"color":"#fff"}},"userConfig":{"x":"TJDATE","y":[{"id":"GWYPZZMJ","name":"test1"},{"id":"SZFPZZMJ","name":"test2"}]},"dataUrl":"http://localhost:8888/api/pie/ydys/v1","width":423,"height":378,"dx":663,"dy":16},"chartType":3}
            ...
            this.$echarts = echarts.init(this.$refs.chart1572068244000, 'chalk', {
            ...
            getChartData(this.dataUrl).then((res)=>{
                ...
                this.setPosition({id:'chart1572068244000',x:mconfig.config.dx,y:mconfig.config.dy,width:mconfig.config.width,height:mconfig.config.height,xData:'',yData:[],yFields:[],dataId:''})
            })
        },
        computed:{
             ...mapGetters(
