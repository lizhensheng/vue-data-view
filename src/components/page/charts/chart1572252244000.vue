<template>
    <div class="chart" ref="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1572252244000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1572252244000',x, y, width, height)"
                                 @activated="onActivated('chart1572252244000')">
            <div @click="deleteChart('chart1572252244000')" class="delete">删除</div>
            <div class="chart" ref="chart1572252244000"
                               style="width: 611px;height:467px;"
                               data-width="611" data-height="467" data-x="33" data-y="22"></div>
    ...
    export default {
        data(){
            return {
                ...
                width:10,
                height:10,
                chartId:'chart1572252244000'
            }
        },
        mounted() {
            let mconfig = {"chartId":"chart1572252244000","config":{"commonConfig":{"tooltip":{"trigger":"axis","axisPointer":{"type":"shadow","label":{"show":true}}},"title":{"text":"","textStyle":{"color":"#D6BC28","fontSize":14}},"textStyle":{"color":"#fff"}},"userConfig":{"x":"username","y":[{"id":"sex","name":"sex"}]},"dataUrl":"http://localhost:8888/api/getChartDataDynamic?id=5db3f2b97a12fb48206afe42","width":611,"height":467,"dx":33,"dy":22},"chartType":1}
            ...
            this.$echarts = echarts.init(this.$refs.chart1572252244000, 'chalk', {
