<template>
    <div class="chart" ref="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1572316127000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1572316127000',x, y, width, height)"
                                 @activated="onActivated('chart1572316127000')">
            <div @click="deleteChart('chart1572316127000')" class="delete">删除</div>
            <div ref="chart1572316127000"
                               style="width: 300px;height:300px;"
                               data-width="300" data-height="300" data-x="193" data-y="124"></div>
...
<script>
    ...
    let chartConfigClass = require('common/js/chartconfig')
    let deepCopy = require('common/js/util')
    export default {
        data(){
            return {
                x:0,
        ...
        mounted() {
            ...
            this.$echarts = echarts.init(this.$refs.chart1572316127000, 'chalk', {
        ...
        watch:{
            increaseId(){
                ...
                if(pos.backgroundColor){
                    this.$refs.chart.style.backgroundColor = pos.backgroundColor
                }
            },
            increaseIdForData(){
                this._refreshData()
