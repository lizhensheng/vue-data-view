<template>
    <div class="chart" ref="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1572317390000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1572317390000',x, y, width, height)"
                                 @activated="onActivated('chart1572317390000')"  ref="draggable">
            <div @click="deleteChart('chart1572317390000')" class="delete">删除</div>
            <div ref="chart1572317390000"
                               style="width: 300px;height:300px;"
                               data-width="300" data-height="300" data-x="79" data-y="69"></div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.$echarts = echarts.init(this.$refs.chart1572317390000, 'chalk', {
