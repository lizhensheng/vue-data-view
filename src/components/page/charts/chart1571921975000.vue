<template>
    <div class="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1571921975000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1571921975000',x, y, width, height)"
                                 @activated="onActivated('chart1571921975000')">
            <div @click="deleteChart('chart1571921975000')" class="delete">删除</div>
            <div class="chart" ref="chart1571921975000"
                               style="width: 412px;height:227px;"
                               data-width="412" data-height="227" data-x="700" data-y="329"></div>
    ...
    export default {
        data(){
            return {
                ...
                width:10,
                height:10,
                chartId:'chart1571921975000'
            }
        },
        mounted() {
            let mconfig = {"chartId":"chart1571921975000","config":{"commonConfig":{"tooltip":{"trigger":"axis","axisPointer":{"type":"shadow","label":{"show":true}}},"title":{"text":"","textStyle":{"color":"#D6BC28","fontSize":14}},"textStyle":{"color":"#fff"}},"userConfig":{"x":"TJDATE","y":[{"id":"GWYPZZMJ","name":"国务院批准总面积"},{"id":"SZFPZZMJ","name":"省政府批准总面积"}],"yAxis":[{"type":"value","name":"面积","axisLabel":{"formatter":"{value} "}}]},"dataUrl":"http://localhost:8888/api/line/ydys/v1","width":412,"height":227,"dx":700,"dy":329},"chartType":1}
            ...
            getChartData(dataUrl).then((res)=>{
               ...
               echarts.registerTheme('chalk',jsonobj)
                this.$echarts = echarts.init(this.$refs.chart1571921975000, 'chalk', {
                ...
                this.setPosition({id:'chart1571921975000',x:mconfig.config.dx,y:mconfig.config.dy,width:mconfig.config.width,height:mconfig.config.height})
            })
        },
        computed:{
             ...mapGetters(
