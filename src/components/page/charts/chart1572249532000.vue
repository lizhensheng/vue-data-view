<template>
    <div class="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1572249532000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1572249532000',x, y, width, height)"
                                 @activated="onActivated('chart1572249532000')">
            <div @click="deleteChart('chart1572249532000')" class="delete">删除</div>
            <div class="chart" ref="chart1572249532000"
                               style="width: 300px;height:300px;"
                               data-width="300" data-height="300" data-x="464" data-y="110"></div>
    ...
    export default {
        data(){
            return {
                ...
                width:10,
                height:10,
                chartId:'chart1572249532000'
            }
        },
        mounted() {
            let mconfig = {"chartId":"chart1572249532000","config":{"commonConfig":{"tooltip":{"trigger":"axis","axisPointer":{"type":"shadow","label":{"show":true}}},"title":{"text":"","textStyle":{"color":"#D6BC28","fontSize":14}},"textStyle":{"color":"#fff"}},"userConfig":{"x":"TJDATE","y":[{"id":"GWYPZZMJ","name":"test1"},{"id":"SZFPZZMJ","name":"test2"}]},"dataUrl":"http://localhost:8888/api/bar/ydys/v1","width":300,"height":300,"dx":464,"dy":110},"chartType":2}
            ...
            this.$echarts = echarts.init(this.$refs.chart1572249532000, 'chalk', {
            ...
            getChartData(this.dataUrl).then((res)=>{
                ...
                this.setPosition({id:this.chartId,chartType:this.chartType,x:mconfig.config.dx,y:mconfig.config.dy,width:mconfig.config.width,height:mconfig.config.height,xData:'',yData:[],yFields:[],dataId:''})
            })
        },
        computed:{
             ...mapGetters(
