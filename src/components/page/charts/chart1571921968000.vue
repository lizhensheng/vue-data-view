<template>
    <div class="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1571921968000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1571921968000',x, y, width, height)"
                                 @activated="onActivated('chart1571921968000')">
            <div @click="deleteChart('chart1571921968000')" class="delete">删除</div>
            <div class="chart" ref="chart1571921968000"
                               style="width: 284px;height:251px;"
                               data-width="284" data-height="251" data-x="333" data-y="322"></div>
    ...
    export default {
        data(){
            return {
                ...
                width:10,
                height:10,
                chartId:'chart1571921968000'
            }
        },
        mounted() {
            let mconfig = {"chartId":"chart1571921968000","config":{"commonConfig":{"tooltip":{"trigger":"axis","axisPointer":{"type":"shadow","label":{"show":true}}},"title":{"text":"","textStyle":{"color":"#D6BC28","fontSize":14}},"textStyle":{"color":"#fff"}},"userConfig":{"x":"TJDATE","y":[{"id":"GWYPZZMJ","name":"国务院批准总面积"},{"id":"SZFPZZMJ","name":"省政府批准总面积"}],"yAxis":[{"type":"value","name":"面积","axisLabel":{"formatter":"{value} "}}]},"dataUrl":"http://localhost:8888/api/line/ydys/v1","width":284,"height":251,"dx":333,"dy":322},"chartType":1}
            ...
            getChartData(dataUrl).then((res)=>{
               ...
               echarts.registerTheme('chalk',jsonobj)
                this.$echarts = echarts.init(this.$refs.chart1571921968000, 'chalk', {
                ...
                this.setPosition({id:'chart1571921968000',x:mconfig.config.dx,y:mconfig.config.dy,width:mconfig.config.width,height:mconfig.config.height})
            })
        },
        computed:{
             ...mapGetters(
