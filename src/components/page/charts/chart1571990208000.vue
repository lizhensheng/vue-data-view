<template>
    <div class="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1571990208000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1571990208000',x, y, width, height)"
                                 @activated="onActivated('chart1571990208000')">
            <div @click="deleteChart('chart1571990208000')" class="delete">删除</div>
            <div class="chart" ref="chart1571990208000"
                               style="width: 100px;height:300px;"
                               data-width="100" data-height="300" data-x="311" data-y="141"></div>
    ...
    export default {
        data(){
            return {
                ...
                width:10,
                height:10,
                chartId:'chart1571990208000'
            }
        },
        mounted() {
            let mconfig = {"chartId":"chart1571990208000","config":{"commonConfig":{"tooltip":{"trigger":"axis","axisPointer":{"type":"shadow","label":{"show":true}}},"title":{"text":"","textStyle":{"color":"#D6BC28","fontSize":14}},"textStyle":{"color":"#fff"}},"userConfig":{"x":"TJDATE","y":[{"id":"GWYPZZMJ","name":"国务院批准总面积"},{"id":"SZFPZZMJ","name":"省政府批准总面积"}],"yAxis":[{"type":"value","name":"面积","axisLabel":{"formatter":"{value} "}}]},"dataUrl":"http://localhost:8888/api/pie/ydys/v1","width":100,"height":300,"dx":311,"dy":141},"chartType":3}
            ...
            this.$echarts = echarts.init(this.$refs.chart1571990208000, 'chalk', {
            ...
            getChartData(this.dataUrl).then((res)=>{
                ...
                this.setPosition({id:'chart1571990208000',x:mconfig.config.dx,y:mconfig.config.dy,width:mconfig.config.width,height:mconfig.config.height,xData:'',yData:[],dataUrl:''})
            })
        },
        computed:{
             ...mapGetters(
