<template>
    <div class="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1571987723000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1571987723000',x, y, width, height)"
                                 @activated="onActivated('chart1571987723000')">
            <div @click="deleteChart('chart1571987723000')" class="delete">删除</div>
            <div class="chart" ref="chart1571987723000"
                               style="width: 300px;height:300px;"
                               data-width="300" data-height="300" data-x="355" data-y="111"></div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.$echarts = echarts.init(this.$refs.chart1571987723000, 'chalk', {
            ...
            getChartData(dataUrl).then((res)=>{
                ...
                this.setPosition({id:'chart1571987723000',x:mconfig.config.dx,y:mconfig.config.dy,width:mconfig.config.width,height:mconfig.config.height})
            })
        },
        computed:{
             ...mapGetters(
