<template>
    <div class="chart">
        <vue-draggable-resizable :x="x"
                                 ...
                                 :w="width"
                                 :h="height"
                                 @dragging="(left, top) =>onDrag('chart1571918568000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1571918568000',x, y, width, height)"
                                 @activated="onActivated('chart1571918568000')">
            <div @click="deleteChart('chart1571918568000')" class="delete">删除</div>
            <div class="chart" ref="chart1571918568000"
                               style="width: 400px;height:400px;"
                               data-width="400" data-height="400" data-x="280" data-y="152"></div>
    ...
    export default {
        data(){
            return {
                ...
                width:0,
                height:0,
                chartId:'chart1571918568000'
            }
        },
        mounted() {
            let mconfig = {"chartId":"chart1571918568000","config":{"commonConfig":{"tooltip":{"trigger":"axis","axisPointer":{"type":"shadow","label":{"show":true}}},"title":{"text":"","textStyle":{"color":"#D6BC28","fontSize":14}},"textStyle":{"color":"#fff"}},"userConfig":{"x":"TJDATE","y":[{"id":"GWYPZZMJ","name":"国务院批准总面积"},{"id":"SZFPZZMJ","name":"省政府批准总面积"}],"yAxis":[{"type":"value","name":"面积","axisLabel":{"formatter":"{value} "}}]},"dataUrl":"http://localhost:8888/api/bar/ydys/v1","width":400,"height":400,"dx":280,"dy":152},"chartType":2}
            ...
            getChartData(dataUrl).then((res)=>{
               ...
               echarts.registerTheme('chalk',jsonobj)
                this.$echarts = echarts.init(this.$refs.chart1571918568000, 'chalk', {
                ...
                this.setPosition({id:'chart1571918568000',x:mconfig.config.dx,y:mconfig.config.dy,width:mconfig.config.width,height:mconfig.config.height})
            })
        },
        computed:{
             ...mapGetters(
