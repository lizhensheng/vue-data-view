<template>
    <div class="chart">
        <vue-draggable-resizable :x="157"
                                 :y="102"
                                 :w="400"
                                 :h="400"
                                 @dragging="(left, top) =>onDrag('chart1571813445000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1571813445000',x, y, width, height)"
                                 @activated="onActivated('chart1571813445000')">
            <div @click="deleteChart('chart1571813445000')" class="delete">删除</div>
            <div class="chart" ref="chart1571813445000"
                               style="width: 400px;height:400px;"
                               data-width="400" data-height="400" data-x="157" data-y="102"></div>
...
<script>
    ...
    export default {
        mounted() {
            let mconfig = {"chartId":"chart1571813445000","config":{"commonConfig":{"tooltip":{"trigger":"axis","axisPointer":{"type":"shadow","label":{"show":true}}},"title":{"text":"","textStyle":{"color":"#D6BC28","fontSize":14}},"textStyle":{"color":"#fff"}},"userConfig":{"x":"TJDATE","y":[{"id":"GWYPZZMJ","name":"国务院批准总面积"},{"id":"SZFPZZMJ","name":"省政府批准总面积"}],"yAxis":[{"type":"value","name":"面积","axisLabel":{"formatter":"{value} "}}]},"dataUrl":"http://localhost:8888/api/bar/ydys/v1","width":400,"height":400,"dx":157,"dy":102},"chartType":2}
            ...
            getChartData(dataUrl).then((res)=>{
               ...
               echarts.registerTheme('chalk',jsonobj)
                this.$echarts = echarts.init(this.$refs.chart1571813445000, 'chalk', {
