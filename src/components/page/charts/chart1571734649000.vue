<template>
    <div class="chart">
        <vue-draggable-resizable :x="462" :y="33" :w="299" :h="275" @dragging="(left, top) =>onDrag('chart1571734649000',left,top)" @resizing="(x, y, width, height) =>onResize('chart1571734649000',x, y, width, height)"  @activated="onActivated('chart1571734649000')">
            <div @click="deleteChart('chart1571734649000')" class="delete">删除</div>
            <div class="chart" ref="chart1571734649000" style="width: 299px;height:275px;"></div>
...
<script>
    ...
    export default {
        mounted() {
            let mconfig = {"chartId":"chart1571734649000","config":{"commonConfig":{"tooltip":{"trigger":"axis","axisPointer":{"type":"shadow","label":{"show":true}}},"title":{"text":"","textStyle":{"color":"#D6BC28","fontSize":14}},"textStyle":{"color":"#fff"}},"userConfig":{"x":"TJDATE","y":[{"id":"GWYPZZMJ","name":"国务院批准总面积"},{"id":"SZFPZZMJ","name":"省政府批准总面积"}],"yAxis":[{"type":"value","name":"面积","axisLabel":{"formatter":"{value} "}}]},"dataUrl":"http://localhost:8888/api/pie/ydys/v1","width":299,"height":275,"dx":462,"dy":33},"chartType":3}
            ...
            getChartData(dataUrl).then((res)=>{
               ...
               echarts.registerTheme('chalk',jsonobj)
                this.$echarts = echarts.init(this.$refs.chart1571734649000, 'chalk', {
