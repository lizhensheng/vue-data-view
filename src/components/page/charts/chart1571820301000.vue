<template>
    <div class="chart">
        <vue-draggable-resizable :x="136"
                                 :y="73"
                                 :w="446"
                                 :h="231"
                                 @dragging="(left, top) =>onDrag('chart1571820301000',left,top)"
                                 @resizing="(x, y, width, height) =>onResize('chart1571820301000',x, y, width, height)"
                                 @activated="onActivated('chart1571820301000')">
            <div @click="deleteChart('chart1571820301000')" class="delete">删除</div>
            <div class="chart" ref="chart1571820301000"
                               style="width: 446px;height:231px;"
                               data-width="446" data-height="231" data-x="136" data-y="73"></div>
...
<script>
    ...
    export default {
        mounted() {
            let mconfig = {"chartId":"chart1571820301000","config":{"commonConfig":{"tooltip":{"trigger":"axis","axisPointer":{"type":"shadow","label":{"show":true}}},"title":{"text":"","textStyle":{"color":"#D6BC28","fontSize":14}},"textStyle":{"color":"#fff"}},"userConfig":{"x":"TJDATE","y":[{"id":"GWYPZZMJ","name":"国务院批准总面积"},{"id":"SZFPZZMJ","name":"省政府批准总面积"}],"yAxis":[{"type":"value","name":"面积","axisLabel":{"formatter":"{value} "}}]},"dataUrl":"http://localhost:8888/api/pie/ydys/v1","width":"446","height":"231","dx":136,"dy":73},"chartType":3}
            ...
            getChartData(dataUrl).then((res)=>{
               ...
               echarts.registerTheme('chalk',jsonobj)
                this.$echarts = echarts.init(this.$refs.chart1571820301000, 'chalk', {
